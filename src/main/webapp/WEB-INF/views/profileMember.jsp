            ...
            <div class="col-md-12 pl-lg-0">
                <div class="text bg-black-1">
                    <div class="header">
                        ...
                        <div class="d-flex justify-content-between col-xs-8">
                            <div class="name">
                                <h2 class="h3">Member Dashboard</h2>
                                <p>
                ...
                <div class="body">
                    ...
                    <ul class="secondary-nav-menu list-inline ml-auto mb-0">
                        ...
                        <section class="new-properties">
                            <div class="container">
                                <header class="text-center">
                                    <h2><span class="text-primary">Your</span>Products <span class="text-primary">for sale</span>
                                    </h2>
                                    <div class="row">
                                        <p class="template-text col-lg-8 mx-auto"></p>
                                    </div>
                                </header>
                                <div class="row">
                ...
                <div class="footer d-flex justify-content-between text-md-center flex-column flex-md-row">
                    <div class="item d-flex align-items-center mb-2 mb-lg-0">
                        ...
                        <div class="number"><span><h3>MEMBER  LICENSE (AFDEMP MEMBER PREMIUM)</h3></span></div>
