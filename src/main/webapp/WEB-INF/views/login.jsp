            ...
            <div class="col-md-12">
                ...
                <form method="POST" action="${contextPath}/login" class="form-signin">
                    ...
                    <div style="color: whitesmoke;" class="form-group ${error != null ? 'has-error' : ''}">
                        ...
                        <input name="username" style="MARGIN-BOTTOM:30PX;" type="text" class="form-control"
                        ...
                        <p STYLE="padding-top: 20px;" class="text-center"><a href="${contextPath}/registration">Not
                            Registered? JOIN NOW</a></p>
                    </div>
                </form>
            </div>
