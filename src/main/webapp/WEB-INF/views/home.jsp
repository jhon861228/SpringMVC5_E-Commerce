    ...
    <div class="swiper-container hero-slider">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div style="background: url(<c:url value="/resources/img/shopping.jpg"/>);"
        ...
        <section class="new-properties bg-black-3">
            <div class="container">
                <header class="text-center">
                    <h2><span class="text-primary">FEATURED</span>Products <span class="text-primary">for sale</span>
                    </h2>
                    <div class="row">
                        <p class="template-text col-lg-8 mx-auto">Take A Look at Our Stunning Products and Buy Yours
                            Today or Save it in your Wishlist.</p>
                    </div>
                </header>
                <div class="row">
    ...
    <div class="container">
        <div class="row d-flex align-items-stretch">
            <div class="col-lg-6 pr-lg-0">
                <div class="image"><img src="<c:url value="/resources/img/about-img.jpeg" />" alt="..."
                                        class="img-fluid"></div>
            </div>
            <div class="col-lg-6 pl-lg-0">
                <div class="text d-flex align-items-center">
                    <div class="text-inner"><strong>About Us</strong>
                        ...
                        <p>Ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti. </p><a href="#"
                                                                                                         class="btn btn-gradient">Read
                            More</a>
                    </div>
                </div>
            </div>
